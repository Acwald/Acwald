...
#### 同时要学一些这些（研究从👴变成👦的方法）
![数学分析](https://img.shields.io/badge/-Analysis-red?style=flat-square) ![高等代数](https://img.shields.io/badge/-Algebra-orange?style=flat-square) ![数学物理方法](https://img.shields.io/badge/-Physics-success?style=flat-square)
